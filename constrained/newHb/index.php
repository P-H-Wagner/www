...
<body>
    <h1>Constrained Fitter Plots - new Hb</h1>
...
<div class="figure-container">
    <p> Stacked Plots </p>
    <?php
        $files = glob('/eos/user/p/pahwagne/www/constrained/stackedplots/*_constrained_newHb.png');
...
<div class="figure-container">
    ...
    <?php
        $files = glob('/eos/user/p/pahwagne/www/constrained/normplots/*_constrained_newHb.png');
        foreach($files as $file) {
            if($file !== "." && $file !== "..") {
                $filename = basename($file); # get filename only
                echo "<figure>";
