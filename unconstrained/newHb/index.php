...
<body>
    <h1>Unconstrained Fitter Plots - new Hb</h1>
...
<div class="figure-container">
    <p> Stacked Plots </p>
    <?php
        $files = glob('/eos/user/p/pahwagne/www/unconstrained/stackedplots/*unconstrained_newHb.png');
...
<div class="figure-container">
    ...
    <?php
        $files = glob('/eos/user/p/pahwagne/www/unconstrained/normplots/*unconstrained_newHb.png');
        foreach($files as $file) {
            if($file !== "." && $file !== "..") {
                $filename = basename($file); # get filename only
                echo "<figure>";
